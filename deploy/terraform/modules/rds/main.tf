...
resource "alicloud_db_instance" "this" {
  ...
  zone_id_slave_a      = data.alicloud_vswitch.b.zone_id
...
resource "alicloud_rds_database" "this" {
  db_instance_id = alicloud_db_instance.this.id
  db_name        = var.database_name
}

# SQL 审计：通过 SLS 日志服务投递
resource "alicloud_db_instance_sql_audit" "this" {
  db_instance_id = alicloud_db_instance.this.id
  sql_audit      = "MODIFY"
}
