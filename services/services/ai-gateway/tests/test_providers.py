...
class TestOpenAICompatibleProvider:
    ...
    async def test_non_stream(self, monkeypatch):
        ...
        chunks = [
            c
            async for c in provider.chat_completion(
            ...
            class FakeResp:
                ...
                async def aiter_lines(self):
                    for line in [
                        ...
                        'data: {"choices":[{"delta":{},"index":0,"finish_reason":"stop"}],"usage":{"prompt_tokens":10,"completion_tokens":20,"total_tokens":30}}',
                        "data: [DONE]",
                    ]:
                        yield line
            ...
            class FakeResp:
                ...
                async def aiter_lines(self):
                    for line in [
                        ...
                        "event: message_delta",
                        'data: {"type":"message_delta","delta":{"stop_reason":"end_turn"},"usage":{"input_tokens":15,"output_tokens":10}}',
                        "event: message_stop",
